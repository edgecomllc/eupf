...
| IP Pool <br>`Optional`         | Pool of IP addresses, needed to allocate ip when the UEIP function is enabled                                                                                                                                                                                                                                                                   | `ip_pool`         | `UPF_IP_POOL`         | ``          | `10.61.0.0/16` |
| TEID Pool <br>`Optional`       | Pool of TEIDs, needed to allocate ip when the FTUP function is enabled                                                                                                                                                                                                                                                                          | `teid_pool`       | `UPF_TEID_POOL`       | ``          | `65536`        |
