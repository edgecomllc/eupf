...
Trace incomming packets `Optional`             | Trace incomming dataplane packets                                                                                                                                                                                                             | `trace_in`             | UPF_TRACE_IN               | --tracein          | TRUE
Trace outgoing packets `Optional`             | Trace outgoing dataplane packets                                                                                                                                                                                                             | `trace_out`             | UPF_TRACE_OUT               | --traceout          | TRUE
Trace droppped packets `Optional`             | Trace dropped dataplane packets                                                                                                                                                                                                             | `trace_blocked`             | UPF_TRACE_BLOCKED               | --traceblock          | FALSE
