...
func testDLwithGTPPort(t *testing.T, bpfObjects *BpfObjects) error {
	...
	n3AddressUint32 := binary.LittleEndian.Uint32(net.ParseIP("1.2.3.4").To4())
	n9AddressUint32 := binary.LittleEndian.Uint32(net.ParseIP("2.2.2.2").To4())
	entrypointConfig := IpEntrypointDataplaneConfig{N3Ipv4Address: n3AddressUint32, N9Ipv4Address: n9AddressUint32}
	if err := bpfObjects.GlobalConfig.Set(entrypointConfig); err != nil {
		return fmt.Errorf("scan't set dataplane global config: %v", err)
	}
