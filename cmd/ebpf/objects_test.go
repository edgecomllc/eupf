...
func testGtpWithSDFFilterV6(bpfObjects *BpfObjects) error {
	...
	sdf := SdfFilter{
		Protocol:     1,
		SrcAddress:   IpWMask{Type: 2, Ip: net.ParseIP("2001:db8::2"), Mask: net.IPMask{255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255}},
		DstAddress:   IpWMask{Type: 2, Ip: net.ParseIP("2001:db8::1"), Mask: net.IPMask{255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255}},
		SrcPortRange: PortRange{LowerBound: 0, UpperBound: 65535},
		DstPortRange: PortRange{LowerBound: 0, UpperBound: 65535},
	}
	pdr.SdfFilter = []SdfFilter{sdf}
...
func TestEntrypoint(t *testing.T) {
	...
	t.Run("SDF filter test for IPv6", func(t *testing.T) {
